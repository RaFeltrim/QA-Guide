...
1. Criar pipeline (GitHub Actions) que execute: unit tests → integration tests → E2E (quando aplicável). Veja exemplos em [CNPJ-Docs — Exemplos Práticos](https://github.com/RaFeltrim/CNPJ-Docs/blob/main/docs/testing/shift-left-testing/05-exemplos-pratica/README.md).
