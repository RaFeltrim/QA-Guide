ARCHIVED: original path `features/cnpj_conhecido_valido.md`
Moved on: 2025-12-22
...
```
ARCHIVED: original file from `features/cnpj_conhecido_valido.md`
Moved to `docs/cnpj/cnpj_conhecido_valido.md`.
Source: features/cnpj_conhecido_valido.md
