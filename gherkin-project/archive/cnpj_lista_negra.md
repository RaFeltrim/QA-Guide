ARCHIVED: original path `features/cnpj_lista_negra.md`
Moved on: 2025-12-22
...
````
ARCHIVED: original file from `features/cnpj_lista_negra.md`
Moved to `docs/cnpj/cnpj_lista_negra.md`.
Source: features/cnpj_lista_negra.md
