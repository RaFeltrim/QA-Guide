...
`````
ARCHIVED: original path `features/cnpj_numerico_01.md`
Moved on: 2025-12-22
...
```
ARCHIVED: original file from `features/cnpj_numerico_01.md`
Moved to `docs/cnpj/cnpj_numerico_01.md`.
Source: features/cnpj_numerico_01.md
