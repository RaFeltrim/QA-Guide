ARCHIVED: original path `features/cnpj_edge_cases.md`
Moved on: 2025-12-22
...
```
ARCHIVED: original file from `features/cnpj_edge_cases.md`
Moved to `docs/cnpj/cnpj_edge_cases.md`.
Source: features/cnpj_edge_cases.md
