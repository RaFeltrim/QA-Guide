ARCHIVED: original path `features/cnpj_formatacao_mascara.md`
Moved on: 2025-12-22
...
````
ARCHIVED: original file from `features/cnpj_formatacao_mascara.md`
Moved to `docs/cnpj/cnpj_formatacao_mascara.md`.
Source: features/cnpj_formatacao_mascara.md
